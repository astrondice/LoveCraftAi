...
export const Route = createFileRoute("/signup")({
  ...
  head: () => ({
    meta: [{ title: "Create Account — LoveCraft AI" }, { name: "robots", content: "noindex" }],
  }),
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="font-display text-3xl md:text-4xl text-ivory">
            Begin your <span className="italic gold-shimmer">story</span>
          </h1>
          <p className="mt-2 text-ivory/50 text-sm">Free forever. No credit card required.</p>
        </div>
        ...
        {signupDone ? (
          ...
          >
            ...
            <h2 className="font-display text-2xl text-ivory mb-3">Check your inbox</h2>
              ...
              {(["oauth", "password"] as Method[]).map((m) => (
                <button
                  ...
                  className={`flex-1 rounded-full py-2 text-[11px] font-semibold uppercase tracking-widest transition-all ${
                    method === m ? "bg-gold text-charcoal" : "text-ivory/50 hover:text-ivory"
                  }`}
                >
