...
import { WebsiteBlueprint, WebsiteType, ColorPalette, TypographyPairing, AnimationStyle, MediaAsset } from "../../types/blueprint";
  ...
  async generate(input: GenerationInput): Promise<WebsiteBlueprint> {
    ...
    return {
      ...
      seo: {
        ...
        description: input.message ? input.message.substring(0, 150) + "..." : "A beautiful journey together.",
